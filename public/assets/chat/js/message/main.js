$(document).ready(function () {
	...
	function getUserList() {
		return new Promise(function (resolve, reject) { //Creating new Promise Chain
			...
			$.get('Pesan/userDetail', function (data) {
			...
			$('.innerBox').click(function () {
				...
				getBlockUserData();
				setInterval(getBlockUserData, 900);

				getUserDetails(unique_id);
				inter2 = setInterval(getUserList, 9000);
	...
	function getUserDetails(uniq_id) {
		// console.log('ok')
		$.post('Pesan/getIndividual', { data: uniq_id }, function (data) {
	...
	inter2 = setInterval(getUserList, 9000); //Calling the root function with interval
})
