            ...
            <footer class="bg-one">
                <div class="atas-footer" style="background-color: white;">
                    ...
                    <div class="row justify-content-around">
                        <div class="col-4" style="margin-left: 10px; text-align: justify;">
                            Madu memiliki aktivitas antimikroba yang bisa menghambat pertumbuhan mikrob yang disebabkan oleh kandungan air yang rendah. Selain itu, madu juga dapat digunakan untuk menyembuhkan tukak peptik/penyakit maag yang disebabkan oleh infeksi Helicobacter pylori. Madu juga memiliki aktivitas antivirus.
                        </div>

                        <div class="col-3">
                            <img src="<?= base_url() ?>/set_admin/<?= $set['logo']; ?>" alt="logo" style="width: 100%; height: 100%;" alt="Tabler" class="navbar-brand-image">
                        </div>
